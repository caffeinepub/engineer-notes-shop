...
export class Backend implements backendInterface {
    ...
    async downloadProductFile(arg0: string): Promise<ExternalBlob> {
        if (this.processError) {
            try {
    ...
    async getPurchasedProductIds(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPurchasedProductIds();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setProductPublished(arg0: string, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setProductPublished(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadProductFile(arg0: string, arg1: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadProductFile(arg0, await to_candid_ExternalBlob_n19(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_ProductList_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ProductList): Promise<ProductList> {
    return await from_candid_vec_n11(_uploadFile, _downloadFile, value);
}
...
async function from_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        file: record_opt_to_undefined(await from_candid_opt_n14(_uploadFile, _downloadFile, value.file)),
        author: value.author,
